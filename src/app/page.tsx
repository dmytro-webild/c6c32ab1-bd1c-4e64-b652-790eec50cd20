      ...
      bulletPoints={[
        {
          ...
          description: "We hand-roast our beans in small batches.",
        },
        {
          title: "Fresh Ingredients",
          description: "Sourced daily from our partner farms.",
        },
        {
          title: "Community Focus",
          description: "A gathering space for everyone.",
        },
      ]}
      ...
      products={[
        {
          ...
          price: "$4.50",
          imageSrc: "http://img.b2bpic.net/free-photo/hot-coffee-cup-with-cappuccino-latte-art-eyeglasses-open-book-table_23-2147893349.jpg",
        },
        {
          id: "item2",
          name: "Artisan Latte",
          price: "$5.00",
          imageSrc: "http://img.b2bpic.net/free-photo/front-view-view-tasty-cupcake-with-chocolate-chips_23-2148718786.jpg",
        },
        {
          id: "item3",
          name: "Americano",
          price: "$3.75",
          imageSrc: "http://img.b2bpic.net/free-photo/chocolate-mousse-dessert-garnished-with-mint-leaf-isolated-white-background_123827-26243.jpg",
        },
      ]}
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        },
        {
          ...
          name: "Bob Smith",
          handle: "@bobsmith",
          testimonial: "Perfect spot to work and relax.",
        ...
        },
        {
          ...
          name: "Charlie D.",
          handle: "@charlied",
          testimonial: "I visit every single morning.",
      ...
      faqs={[
        {
          ...
          content: "Yes, we offer a variety of milk alternatives.",
        },
        {
          id: "f2",
          title: "Are you open on weekends?",
          content: "Absolutely, we are open 7 days a week.",
        },
        {
          id: "f3",
